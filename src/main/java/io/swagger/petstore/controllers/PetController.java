...
import io.swagger.petstore.models.ContentTypeEnum;
import io.swagger.petstore.models.Pet;
import io.swagger.petstore.models.PetRequest;
...
public final class PetController extends BaseController {
    ...
    public void updatePetWithForm(
        ...
        prepareUpdatePetWithFormRequest(petId, contentType, name, status).execute();
    }
    ...
    public CompletableFuture<Void> updatePetWithFormAsync(
            ...
            final String status) {
        try {
            return prepareUpdatePetWithFormRequest(petId, contentType, name, status).executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    }
     ...
     */
    public void addPet(
            final PetRequest body) throws ApiException, IOException {
