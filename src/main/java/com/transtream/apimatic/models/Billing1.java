...
/**
 * This is a model class for Billing1 type.
 */
public class Billing1 {
    ...
    /**
     * Converts this Billing1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Billing1 [" + "name=" + name + ", companyName=" + companyName + ", street=" + street
    ...
    /**
     * Builds a new {@link Billing1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Billing1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Billing1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Billing1} object using the set fields.
         * @return {@link Billing1}
         */
        public Billing1 build() {
            return new Billing1(name, companyName, street, locale, other, city, region, postalCode,
                    country, phone, email);
        }
    }
}
