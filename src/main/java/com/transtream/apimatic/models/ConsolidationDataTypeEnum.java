...
/**
 * ConsolidationDataTypeEnum to be used.
 */
public enum ConsolidationDataTypeEnum {
    ...
    private static TreeMap<Integer, ConsolidationDataTypeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ConsolidationDataTypeEnum constructFromInteger(Integer toConvert) throws IOException {
        ConsolidationDataTypeEnum enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static ConsolidationDataTypeEnum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of ConsolidationDataTypeEnum values to list of integer values.
     * @param toConvert The list of ConsolidationDataTypeEnum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<ConsolidationDataTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<Integer> convertedValues = new ArrayList<>();
        for (ConsolidationDataTypeEnum enumValue : toConvert) {
