...
/**
 * This is a model class for Receiver1 type.
 */
public class Receiver1 {
    ...
    /**
     * Converts this Receiver1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Receiver1 [" + "companyName=" + companyName + ", street=" + street + ", locale="
                ...
                + ", phone=" + phone + ", departmentName=" + departmentName + "]";
    }

    /**
     * Builds a new {@link Receiver1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Receiver1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Receiver1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Receiver1} object using the set fields.
         * @return {@link Receiver1}
         */
        public Receiver1 build() {
            return new Receiver1(companyName, street, locale, other, city, region, regionName,
                    postalCode, country, countryName, residential, phone, departmentName);
        }
    }
}
