...
public enum PurposeEnum {
    ...
    private static TreeMap<Integer, PurposeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static PurposeEnum constructFromInteger(Integer toConvert) throws IOException {
        PurposeEnum enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static PurposeEnum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of PurposeEnum values to list of integer values.
     * @param toConvert The list of PurposeEnum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<PurposeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<Integer> convertedValues = new ArrayList<>();
        for (PurposeEnum enumValue : toConvert) {
