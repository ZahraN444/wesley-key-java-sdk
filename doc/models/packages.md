...
|  --- | --- | --- | --- | --- | --- |
| `Package` | [`List<Package>`](../../doc/models/package.md) | Required | Container for an individual package associated with the transaction. | List<Package> getPackage() | setPackage(List<Package> mPackage) |
