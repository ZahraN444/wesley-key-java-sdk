...
|  --- | --- | --- | --- | --- | --- |
| `Package` | [`List<Package7>`](../../doc/models/package-7.md) | Required | Container for an individual package associated with the transaction. | List<Package7> getPackage() | setPackage(List<Package7> mPackage) |
...
<wtg:Packages xmlns:wtg="https://www.wisetechglobal.com/">
  <wtg:Package xmlns:wtg="https://www.wisetechglobal.com/">
    ...
    <wtg:ThirdPartyConsignee>false</wtg:ThirdPartyConsignee>
    ...
    <wtg:RefrigerationRequired>false</wtg:RefrigerationRequired>
