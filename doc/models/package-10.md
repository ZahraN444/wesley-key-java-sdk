...
|  --- | --- | --- | --- | --- | --- |
| `CartonID` | `int` | Required | Numeric identifier for a carton.<br><br>**Default**: `0` | int getCartonID() | setCartonID(int cartonID) |
| `Name` | `String` | Optional | Package name returned by cartonization carrier. | String getName() | setName(String name) |
...
| `International` | [`International3`](../../doc/models/international-3.md) | Optional | Container for international details associated with the shipment. | International3 getInternational() | setInternational(International3 international) |
| `Rates` | [`Rates10`](../../doc/models/rates-10.md) | Optional | Container all rates associated with the transaction. | Rates10 getRates() | setRates(Rates10 rates) |

## Example (as XML)

```xml
<wtg:Package xmlns:wtg="https://www.wisetechglobal.com/">
  <wtg:CartonID xmlns:wtg="https://www.wisetechglobal.com/">0</wtg:CartonID>
  ...
  <wtg:ExternalTrackingID xmlns:wtg="https://www.wisetechglobal.com/">ExternalTrackingID2</wtg:ExternalTrackingID>
</wtg:Package>
```
