...
| `ValuesCalculated` | `Boolean` | Optional | Internally reserved element.<br><br>**Default**: `false` | Boolean getValuesCalculated() | setValuesCalculated(Boolean valuesCalculated) |
...
| `Length` | `Double` | Optional | Length of a single line item.<br><br>**Default**: `0d` | Double getLength() | setLength(Double length) |
| `Width` | `Double` | Optional | Width of a single line item.<br><br>**Default**: `0d` | Double getWidth() | setWidth(Double width) |
| `Height` | `Double` | Optional | Height of a single line item.<br><br>**Default**: `0d` | Double getHeight() | setHeight(Double height) |
...
| `ThirdPartyHazardous` | [`ThirdPartyHazardous1`](../../doc/models/third-party-hazardous-1.md) | Optional | Container for details for processing by an external hazardous compliance system. | ThirdPartyHazardous1 getThirdPartyHazardous() | setThirdPartyHazardous(ThirdPartyHazardous1 thirdPartyHazardous) |
...
<wtg:Content xmlns:wtg="https://www.wisetechglobal.com/">
  ...
  <wtg:ValuesCalculated xmlns:wtg="https://www.wisetechglobal.com/">false</wtg:ValuesCalculated>
  ...
  <wtg:ContentCode xmlns:wtg="https://www.wisetechglobal.com/">ContentCode8</wtg:ContentCode>
