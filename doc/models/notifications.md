...
| `ShipmentNotificationDetail` | [`ShipmentNotificationDetail`](../../doc/models/shipment-notification-detail.md) | Optional | Container for shipment notification deails. | ShipmentNotificationDetail getShipmentNotificationDetail() | setShipmentNotificationDetail(ShipmentNotificationDetail shipmentNotificationDetail) |
...
| `ExceptionNotificationDetail` | [`ExceptionNotificationDetail`](../../doc/models/exception-notification-detail.md) | Optional | Container for shipment exception notification deails. | ExceptionNotificationDetail getExceptionNotificationDetail() | setExceptionNotificationDetail(ExceptionNotificationDetail exceptionNotificationDetail) |
...
| `PredictNotification` | [`PredictNotification`](../../doc/models/predict-notification.md) | Optional | Container for predict email notification deails. | PredictNotification getPredictNotification() | setPredictNotification(PredictNotification predictNotification) |
