...
|  --- | --- | --- | --- | --- | --- |
| `RecordIdentifiers` | [`RecordIdentifiers6`](../../doc/models/record-identifiers-6.md) | Optional | Outer container for transaction identifiers. | RecordIdentifiers6 getRecordIdentifiers() | setRecordIdentifiers(RecordIdentifiers6 recordIdentifiers) |
| `Code` | `Integer` | Optional | Harmonized, or Schedule-B, code for the item.<br><br>**Default**: `0` | Integer getCode() | setCode(Integer code) |
