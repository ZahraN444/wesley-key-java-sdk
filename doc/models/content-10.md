...
|  --- | --- | --- | --- | --- | --- |
| `RecordIdentifiers` | [`RecordIdentifiers9`](../../doc/models/record-identifiers-9.md) | Optional | Outer container for transaction identifiers. | RecordIdentifiers9 getRecordIdentifiers() | setRecordIdentifiers(RecordIdentifiers9 recordIdentifiers) |
| `Code` | `String` | Optional | Harmonized, or Schedule-B, code for the item. | String getCode() | setCode(String code) |
...
| `OrderID` | `Integer` | Optional | The unique numeric identifier for the order.<br><br>**Default**: `0` | Integer getOrderID() | setOrderID(Integer orderID) |
