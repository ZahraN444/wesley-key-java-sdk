...
| `Charges` | [`Charges6`](../../doc/models/charges-6.md) | Required | Container for all charges within the group associated with the transaction. | Charges6 getCharges() | setCharges(Charges6 charges) |
...
<wtg:ChargeGroup xmlns:wtg="https://www.wisetechglobal.com/">
  ...
  <wtg:ChargeGroupCurrency xmlns:wtg="https://www.wisetechglobal.com/">ChargeGroupCurrency6</wtg:ChargeGroupCurrency>
  <wtg:ChargeGroupISOCurrencySymbol xmlns:wtg="https://www.wisetechglobal.com/">ChargeGroupISOCurrencySymbol6</wtg:ChargeGroupISOCurrencySymbol>
</wtg:ChargeGroup>
```
