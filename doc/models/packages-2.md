...
|  --- | --- | --- | --- | --- | --- |
| `Package` | [`List<Package2>`](../../doc/models/package-2.md) | Required | Container for an individual package associated with the transaction. | List<Package2> getPackage() | setPackage(List<Package2> mPackage) |
