...
# Third Party Hazardous 2

Container for details for processing by an external hazardous compliance system.

## Structure

`ThirdPartyHazardous2`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `Materials` | [`Materials1`](../../doc/models/materials-1.md) | Optional | Container for all material details. | Materials1 getMaterials() | setMaterials(Materials1 materials) |
...
| `ToxicInhalationHazardZone` | `String` | Optional | Hazardous name key for the product for 3rd party hazardous partner. | String getToxicInhalationHazardZone() | setToxicInhalationHazardZone(String toxicInhalationHazardZone) |
...
<wtg:ThirdPartyHazardous xmlns:wtg="https://www.wisetechglobal.com/">
  ...
  <wtg:MaterialKey xmlns:wtg="https://www.wisetechglobal.com/">MaterialKey6</wtg:MaterialKey>
  <wtg:NameKey xmlns:wtg="https://www.wisetechglobal.com/">NameKey4</wtg:NameKey>
  <wtg:InnerPackagingType xmlns:wtg="https://www.wisetechglobal.com/">InnerPackagingType6</wtg:InnerPackagingType>
  <wtg:PackageInstructionType xmlns:wtg="https://www.wisetechglobal.com/">PackageInstructionType2</wtg:PackageInstructionType>
