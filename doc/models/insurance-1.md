...
|  --- | --- | --- | --- | --- | --- |
| `Type` | `Integer` | Optional | Type of insurance.  Defaults to no insurance if not submitted.<br><br>**Constraints**: *Pattern*: `[1]` | Integer getType() | setType(Integer type) |
...
<wtg:Insurance xmlns:wtg="https://www.wisetechglobal.com/">
  ...
  <wtg:Type xmlns:wtg="https://www.wisetechglobal.com/">38</wtg:Type>
  <wtg:ValueCurrency xmlns:wtg="https://www.wisetechglobal.com/">ValueCurrency0</wtg:ValueCurrency>
</wtg:Insurance>
```
