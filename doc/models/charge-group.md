...
| `ChargeGroupValue` | `double` | Required | The value of the charge group associated with the transaction.<br><br>**Default**: `0d` | double getChargeGroupValue() | setChargeGroupValue(double chargeGroupValue) |
...
| `Charges` | [`Charges`](../../doc/models/charges.md) | Required | Container for all charges within the group associated with the transaction. | Charges getCharges() | setCharges(Charges charges) |
