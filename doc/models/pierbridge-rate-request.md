...
Performs a rate request with a carrier, used in order to gain a quote for a shipment.
...
|  --- | --- | --- | --- | --- | --- |
| `Localization` | [`Localization`](../../doc/models/localization.md) | Optional | Container for the additional rate types to be requested by the transaction. | Localization getLocalization() | setLocalization(Localization localization) |
...
| `ServiceType` | `int` | Required | Numeric identifier for the carrier service.<br><br>**Default**: `0` | int getServiceType() | setServiceType(int serviceType) |
...
| `InsideDeliveryType` | `Integer` | Optional | Numeric identifer for the type of inside delivery.  Defaults to no inside delivery if not submitted.<br><br>**Constraints**: *Pattern*: `[1-5]` | Integer getInsideDeliveryType() | setInsideDeliveryType(Integer insideDeliveryType) |
...
| `HolidayPickup` | `Boolean` | Optional | Indicates whether the address to be picked up from to is a holiday pickup. Defaults to 'not a holiday pickup' if not submitted.<br><br>**Default**: `false` | Boolean getHolidayPickup() | setHolidayPickup(Boolean holidayPickup) |
...
| `WeekendPickup` | `Boolean` | Optional | Indicates whether the address to be picked up from to is a weekend pickup. Defaults to 'not a weekend pickup' if not submitted.<br><br>**Default**: `false` | Boolean getWeekendPickup() | setWeekendPickup(Boolean weekendPickup) |
...
| `ImportDelivery` | `Boolean` | Optional | Used to indicate whether the package will be delivered from the specified sender address (in a country different than the shipper) | Boolean getImportDelivery() | setImportDelivery(Boolean importDelivery) |
...
| `Sender` | [`Sender`](../../doc/models/sender.md) | Optional | Container to allow the customization of the sender address details associated with the transaction. | Sender getSender() | setSender(Sender sender) |
...
| `Receiver` | [`Receiver`](../../doc/models/receiver.md) | Required | Container for the receiver address details associated with the transaction. | Receiver getReceiver() | setReceiver(Receiver receiver) |
| `ReturnTo` | [`ReturnTo`](../../doc/models/return-to.md) | Optional | Container for any return address assocaited with the transaction. | ReturnTo getReturnTo() | setReturnTo(ReturnTo returnTo) |
| `CODRemittanceAddress` | [`CODRemittanceAddress`](../../doc/models/cod-remittance-address.md) | Optional | Container for the COD remittance address details. | CODRemittanceAddress getCODRemittanceAddress() | setCODRemittanceAddress(CODRemittanceAddress cODRemittanceAddress) |
| `Billing` | [`Billing`](../../doc/models/billing.md) | Optional | Container for billing details associated with the transaction. | Billing getBilling() | setBilling(Billing billing) |
...
| `International` | [`International`](../../doc/models/international.md) | Optional | Container for international details associated with the shipment. | International getInternational() | setInternational(International international) |
| `Packages` | [`Packages`](../../doc/models/packages.md) | Optional | Container for all packages associated with the transaction. | Packages getPackages() | setPackages(Packages packages) |
| `Freight` | [`Freight`](../../doc/models/freight.md) | Optional | Container for freight specific values | Freight getFreight() | setFreight(Freight freight) |
| `Description` | `String` | Optional | Description of the shipment. | String getDescription() | setDescription(String description) |
| `CountryOfManufacture` | `String` | Optional | Country of manufacture. | String getCountryOfManufacture() | setCountryOfManufacture(String countryOfManufacture) |
| `RecipientCountry` | `String` | Optional | Legacy representation of the recipient's country. | String getRecipientCountry() | setRecipientCountry(String recipientCountry) |
| `DeliveryMethod` | `Integer` | Optional | Identifier of the delivery method to use. | Integer getDeliveryMethod() | setDeliveryMethod(Integer deliveryMethod) |
...
| `Cartonization` | [`Cartonization`](../../doc/models/cartonization.md) | Optional | Container for cartonization data for this transaction. | Cartonization getCartonization() | setCartonization(Cartonization cartonization) |
...
| `IsStamps` | `Boolean` | Optional | Indicates that a rate is for a Stamps transaction. | Boolean getIsStamps() | setIsStamps(Boolean isStamps) |
...
```xml
<wtg:PierbridgeRateRequest xmlns:wtg="https://www.wisetechglobal.com/">
  ...
  <wtg:Localization xmlns:wtg="https://www.wisetechglobal.com/"></wtg:Localization>
  <wtg:OtherRateTypes xmlns:wtg="https://www.wisetechglobal.com/"></wtg:OtherRateTypes>
</wtg:PierbridgeRateRequest>
```
