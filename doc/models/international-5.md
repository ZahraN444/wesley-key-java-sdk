...
|  --- | --- | --- | --- | --- | --- |
| `Duty` | [`Duty1`](../../doc/models/duty-1.md) | Optional | Container for duty details assocaited with the transaction. | Duty1 getDuty() | setDuty(Duty1 duty) |
...
| `UltimateConsignee` | [`UltimateConsignee1`](../../doc/models/ultimate-consignee-1.md) | Optional | Container to allow the customization of the ultimate consignee address details associated with the transaction. | UltimateConsignee1 getUltimateConsignee() | setUltimateConsignee(UltimateConsignee1 ultimateConsignee) |
...
<wtg:International xmlns:wtg="https://www.wisetechglobal.com/">
  ...
  <wtg:CustomsReturnReasonDescription xmlns:wtg="https://www.wisetechglobal.com/">CustomsReturnReasonDescription6</wtg:CustomsReturnReasonDescription>
</wtg:International>
```
