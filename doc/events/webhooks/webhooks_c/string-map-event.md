...
This event's request payload is of type [Map<String, String>].
    ...
    public ResponseEntity<String> receiveEvent(
        ...
        String result = handler.verifyAndParseEventAsync(httpRequest).thenApply(webhooksCParsingResult ->
            webhooksCParsingResult.matchSome(new WebhooksCParsingResult.SomeCases<String>() {
                @Override
                public String stringMapEvent(Map<String, String> stringMapEvent) {
                    return MessageFormat.format("StringMapEvent event received {0}", stringMapEvent);
                }
